...
// CSR index (14-bit for LA32R)
typedef Bit#(14) CsrIndx;

// LoongArch CSR addresses used by the processor
...
function Fmt showInst(Instruction inst);
  ...
  case (op6)
    ...
    6'b001000: begin
      ...
      case (op24)
        2'b00: ret = $format("ll.w r%0d, [r%0d + 0x%0x]", rd, rj, signExtend({inst[23:10], 2'b0}));
        2'b01: ret = $format("sc.w r%0d, [r%0d + 0x%0x]", rd, rj, signExtend({inst[23:10], 2'b0}));
